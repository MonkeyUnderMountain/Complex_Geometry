...
\subsection{The first properties}
    ...
    \begin{example}\label{eg:Fubini-Study_metric_on_P^n}
        ...
        The \emph{Fubini-Study metric} \(h_{\text{FS}}\) is a hermitian metric on its tangent bundle \(T \bbP^n\) constructed as follows.
        Recall the \Yang{\(\bbP^n(\bbC) \cong S^{2n+1}/S^1\)} as real manifolds.
